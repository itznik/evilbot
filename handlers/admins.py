...
async def pause(client: Client, message: Message):
    ...
    await message.reply_text("**itznik_x:** ⏸ Paused.")
...
async def resume(client: Client, message: Message):
    ...
    await message.reply_text("**itznik_x:** ▶️ Resumed.")
...
async def skip(client: Client, message: Message):
    ...
    await message.reply_text("**itznik_x:** ⏩ Skipped the current song.")
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("**itznik_x:** ❇️ Admin cache refreshed!")
